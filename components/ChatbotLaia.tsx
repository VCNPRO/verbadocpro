...
const LAIA_KNOWLEDGE = {
    greetings: [
        "¡Hola! Soy Laia, tu asistente virtual de VerbadocPro Europa. Mi nombre es de origen griego y significa 'mujer que se expresa con facilidad'. ¿En qué puedo ayudarte hoy?",
        "¡Bienvenido! Soy Laia, mi nombre es de origen griego y significa 'mujer que se expresa con facilidad'. Estoy aquí para ayudarte con VerbadocPro Europa. ¿Qué necesitas saber?",
    ],
    whatIsVerbadoc: "**VerbadocPro Europa** es una herramienta web profesional que convierte automáticamente documentos no estructurados (PDFs, imágenes, facturas, contratos, etc.) en **datos estructurados** para Excel, bases de datos o sistemas empresariales.\n\n✅ 100% Procesamiento en Europa\n✅ Cumplimiento total GDPR\n✅ Asistente de IA integrado\n✅ Multi-documento inteligente\n✅ Aprende de tus correcciones\n✅ Sin almacenamiento persistente",
